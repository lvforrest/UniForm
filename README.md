...
To run the application locally and access it in your browser, open the [UniForm parent folder](./UniForm) then the [client folder](./client) in separate terminals and run the command below in each.
